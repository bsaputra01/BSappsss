...
import com.example.firebasecrud.AddCourse;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CardViewViewHolder> {
    ...
    public CourseAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.example.firebasecrud.R.layout.course_adapter, parent, false);
    ...
    class CardViewViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        CardViewViewHolder(View itemView) {
            super(itemView);
            lbl_subject_course = itemView.findViewById(com.example.firebasecrud.R.id.lbl_subject_course);
            lbl_lecturer_course = itemView.findViewById(com.example.firebasecrud.R.id.lbl_lecturer_course);
            lbl_date_course = itemView.findViewById(com.example.firebasecrud.R.id.lbl_date_course);
            lbl_start_course = itemView.findViewById(com.example.firebasecrud.R.id.lbl_start_course);
            lbl_end_course = itemView.findViewById(com.example.firebasecrud.R.id.lbl_end_course);
            btn_edit = itemView.findViewById(com.example.firebasecrud.R.id.btn_edit_course);
            btn_delete = itemView.findViewById(com.example.firebasecrud.R.id.btn_delete_course);
